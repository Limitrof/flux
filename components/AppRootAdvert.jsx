...
import ListStore from '../stores/ListStoreAdvert';
import AppDispatcher from '../dispatcher/AppDispatcherAdvert';
...
class AppRootAdvert extends React.Component {
	  ...
	  <div  className="row" key="mainform" id="reactroot">
		  ...
		  <div className="col-md-4 hidden-print">
			  <div id="staticPriceAdvert">
				  ...
				  <div className="row">
					  <div className="col-md-8 grayColor ">News and advertising issues</div>
					  <div className="col-md-4 textAlignRight grayColor">{this.state.billDesign} €  <img onClick={_this.cleanCategory} data-id="Ad" src="/img/clear.png" /></div>
				  </div>
