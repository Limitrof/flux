...
/*   items: [
   ...
   items: [

       {
           ...
           ischecked:false,
           category: 'Пакет “А” Optimal online (B2B), 3 месяца',
           showwordprefix:'',
           showwordsuffix:'€',
           comment:'Пакет “А” Optimal online (B2B)',
           baseprice: 4677,
           price: 4677,
           stocked: true,
           name: '',
       ...
       },
       {
           ...
           showwordprefix:'',
           showwordsuffix:'€',
           comment:'Пакет “B” Online + Ofline (B2B)',
           baseprice: 8315,
           price: 8315,
           stocked: true,
           name: '',
       ...
       },
       {
           ...
           showwordprefix:'',
           showwordsuffix:'€',
           comment:'Пакет “С” Online + Ofline VIP (B2B)',
           baseprice: 17426,
           price: 17426,
           stocked: true,
           name: '',
           ...
           usehiddencheckbox:false,
           ischecked:false,
           category: 'Пакет ”С+” Online (B2B) MAX EFFECT (B2B+B2C), 3 месяца',
           showwordprefix:'',
           showwordsuffix:'€',
           comment:'Пакет ”С+” Online (B2B) MAX EFFECT (B2B+B2C)',
           baseprice: 11061,
           price: 11061,
           stocked: true,
           name: '',
