...
//Общая сумма
    ...
    items: [
        ...
        },
        {
            ...
            showwordprefix:'от',
            showwordsuffix:'€',
            comment:'Разработка сайта Интернет-магазина. сайта',
            baseprice: 0,
            price: 750,
            stocked: true,
            name: 'Разработка сайта Интернет-магазина. сайта',
            arrOfVlue:'none',
            formula: 'multi',
            multinumber:1,
            disabledcheck:'',additionaltitle:'',needit: false, min:0,multinumber_source_unicname:'none'
            ...
            if(currentRow.ischecked){
                switch (currentRow.category) {
                    ...
                    case "Платформа для Программы лояльности:":
                        ...
                        break
                    case "Разработка сайта Интернет-магазина.":
